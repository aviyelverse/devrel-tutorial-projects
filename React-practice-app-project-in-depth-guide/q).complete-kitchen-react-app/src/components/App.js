...
import EditRecipePannel from './EditRecipePannel';
...
function App() {
  ...
  function handleRecipeAddButton() {
    ...
    setSelectedRecipeUnique(newRecipeItem.id)
    setRecipes([...recipes, newRecipeItem])
  }


  function handleRecipeDeleteButton(id) {
    if (selectedRecipeUnique != null && selectedRecipeUnique === id)
      setSelectedRecipeUnique(undefined)
  ...
  return (
    <RecipeContext.Provider value={recipeContextValue}>
      ...
      {selectedRecipies && <EditRecipePannel recipe={selectedRecipies} />}
